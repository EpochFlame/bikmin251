...
// name                   ID                                   pID                                members flags      model           anim            animgr          texture        param           collision       stone           childID                              chNum droptype
   ...
   {"Egg",                EnemyTypeID::EnemyID_Egg,            -1,                                1,      0x0207,    "",             "",             "",             "",            "",             "",             "",             -1,                                  0,    BDT_Empty},
   ...
   {"Damagumo",           EnemyTypeID::EnemyID_Damagumo,       -1,                                1,      0x0007,    "",             "",             "",             "",            "",             "",             "",             EnemyTypeID::EnemyID_ShijimiChou,    25,   BDT_Boss}, // correct Damagumo entry
   {"BigFoot",            EnemyTypeID::EnemyID_BigFoot,        -1,                                1,      0x0007,    "",             "",             "",             "",            "",             "",             "",             -1,                                  0,    BDT_Boss},
   {"Houdai",             EnemyTypeID::EnemyID_Houdai,         -1,                                1,      0x0007,    "",             "",             "",             "",            "",             "",             "",             EnemyTypeID::EnemyID_PikiBabyRed,    30,   BDT_Boss},
   ...
   {"OrangePom",          EnemyTypeID::EnemyID_OrangPom,       EnemyTypeID::EnemyID_Pom,          1,      0x0006,    "Pom",          "Pom",          "Pom",          "Pom",         "Pom",          "Pom",          "Pom",          -1,                                  0,    BDT_Empty},
   ...
   {"BigTreasure",        EnemyTypeID::EnemyID_BigTreasure,    -1,                                1,      0x0007,    "",             "",             "",             "",            "",             "",             "",             EnemyTypeID::EnemyID_PikiBabyYellow, 10,   BDT_FinalBoss},
   ...
   {"DangoMushi",         EnemyTypeID::EnemyID_DangoMushi,     -1,                                1,      0x0007,    "",             "",             "",             "",            "",             "",             "",             EnemyTypeID::EnemyID_PikiBabyBlue,   15,   BDT_Boss},
   ...
   {"QueenMongus",        EnemyTypeID::EnemyID_QueenMongus,    -1,                                1,      0x0007,    "",             "Queen",        "Queen",        "Queen",       "",             "",             "Queen",        EnemyTypeID::EnemyID_Baby,           50,   BDT_Boss},
};
// clang-format on
